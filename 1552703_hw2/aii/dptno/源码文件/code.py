...
def input():
    ...
    # file input
    data = pd.read_csv('trade.csv', usecols=['vipno', 'sldat', 'dptno'])
    ...
    data_set = data_set.pivot_table(data_set, index=['vipno'], columns=['dptno'])
...
def input_new():
    ...
    # file input
    data = pd.read_csv('trade_new.csv', usecols=['vipno', 'sldatime', 'dptno'])
